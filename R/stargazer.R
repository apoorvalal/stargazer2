...
function(..., type = "text", title="", style="apsr", summary=NULL, out=NULL, out.header=FALSE,
         ...
         decimal.mark=NULL, df=FALSE, digit.separate=NULL, digit.separator=NULL, digits=NULL, digits.extra=NULL,
         flip=FALSE,
         float=TRUE, float.env="table", font.size=NULL, header=FALSE, initial.zero=NULL, intercept.bottom=TRUE,
         intercept.top=FALSE, keep=NULL, keep.stat=c("N", "rsq", "adj.rsq"), label="", model.names=NULL, model.numbers=NULL,
